...
def submit_result(old_item_id, list_str):
    """
    提交结果
    """
    dict_list = json.loads(list_str)
    item_list = []
...
if pid==0:
    ...
    channel.basic_consume(on_request_getconfig, queue='rpc_getconfig', no_ack=False)
